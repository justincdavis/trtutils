...
class ShuffleNetV2(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download a ShuffleNet V2 model.
        ...
        """
        if imgsz is None:
            imgsz = ShuffleNetV2._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="ShuffleNet V2",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for ShuffleNet V2.

...
class EfficientNet(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download an EfficientNet model.
        ...
        """
        if imgsz is None:
            imgsz = EfficientNet._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="EfficientNet",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for EfficientNet.
...
class EfficientNetV2(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download an EfficientNet V2 model.
        ...
        """
        if imgsz is None:
            imgsz = EfficientNetV2._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="EfficientNet V2",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for EfficientNet V2.

...
class Inception(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download an Inception V3 model.
        ...
        imgsz : int, optional
            The image size to use for the model. Default is 299.
        opset : int
        ...
        """
        if imgsz is None:
            imgsz = Inception._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="Inception V3",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for Inception V3.
        ...
        imgsz : int, optional
            Input image size used for shapes. Default is 299.
        batch_size : int

...
class MobileNetV2(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        if imgsz is None:
            imgsz = MobileNetV2._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="MobileNet V2",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for MobileNet V2.
...
class MobileNetV3(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        if imgsz is None:
            imgsz = MobileNetV3._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="MobileNet V3",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for MobileNet V3.

...
class SwinTransformer(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download a Swin Transformer model.
        ...
        """
        if imgsz is None:
            imgsz = SwinTransformer._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="Swin Transformer",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for Swin Transformer.
...
class SwinTransformerV2(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        Download a Swin Transformer V2 model.
        ...
        """
        if imgsz is None:
            imgsz = SwinTransformerV2._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="Swin Transformer V2",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for Swin Transformer V2.

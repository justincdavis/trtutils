...
class ResNet(Classifier):
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for ResNet.
...
class ResNeXt(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        if imgsz is None:
            imgsz = ResNeXt._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="ResNeXt",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for ResNeXt.
...
class WideResNet(Classifier):
    ...
    def download(
        ...
        *,
        ...
        """
        if imgsz is None:
            imgsz = WideResNet._default_imgsz
        download_model_internal(
            model_type="torchvision_classifier",
            friendly_name="Wide ResNet",
            model=model,
            output=output,
            imgsz=imgsz,
            opset=opset,
    ...
    def build(
        ...
        *,
        ...
        """
        Build a TensorRT engine for Wide ResNet.

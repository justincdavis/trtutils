...
class ResNeXt(Classifier, Model):
    """Alias of Classifier with default args for ResNeXt."""

    _model_type = "torchvision_classifier"
    _friendly_name = "ResNeXt"
    _default_imgsz = 224
    _input_tensors: ClassVar[list[tuple[str, str]]] = [("input", "image")]
...
class WideResNet(Classifier, Model):
    """Alias of Classifier with default args for Wide ResNet."""

    _model_type = "torchvision_classifier"
    _friendly_name = "Wide ResNet"
    _default_imgsz = 224
    _input_tensors: ClassVar[list[tuple[str, str]]] = [("input", "image")]

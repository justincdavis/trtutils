...
md5_code = ...
def rand(shape, dtype=..., stream=...): # -> GPUArray:
    ...
...
class _RandomNumberGeneratorBase:
    ...
    def gen_uniform(self, shape, dtype, stream=...): # -> empty:
        ...
    
    def gen_normal(self, shape, dtype, stream=...): # -> empty:
        ...
    ...
    if get_curand_version() >= (4, 0, 0):
        ...
        def gen_log_normal(self, shape, dtype, mean, stddev, stream=...): # -> empty:
            ...
    ...
    if get_curand_version() >= (5, 0, 0):
        ...
        def gen_poisson(self, shape, dtype, lambda_value, stream=...): # -> empty:
            ...

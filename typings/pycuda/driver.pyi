...
class Out(ArgumentHandler):
    def post_call(self, stream): # -> None:
        ...
...
def bind_array_to_texref(ary, texref): # -> None:
    ...

def matrix_to_texref(matrix, texref, order): # -> None:
    ...

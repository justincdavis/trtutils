...
class TestCUDAGraphLifecycle:
    ...
    def test_init_not_captured(self, cuda_stream):
    ...
    def test_context_manager_capture(self, cuda_stream):
    ...
    def test_start_stop_capture(self, cuda_stream):
    ...
    def test_launch_after_capture(self, cuda_stream):
    ...
    def test_invalidate_clears_state(self, cuda_stream):
    ...
    def test_launch_without_capture_raises(self, cuda_stream):
    ...
    def test_invalidate_without_capture(self, cuda_stream):
    ...
    def test_invalidate_idempotent(self, cuda_stream):
    ...
    def test_del_calls_invalidate(self, cuda_stream):
    ...
    def test_context_manager_returns_self(self, cuda_stream):
    ...
    def test_multiple_capture_cycles(self, cuda_stream):
...
class TestCUDAGraphFunctions:
    ...
    def test_begin_end_capture(self, cuda_stream):
    ...
    def test_begin_capture_with_explicit_mode(self, cuda_stream):
    ...
    def test_instantiate_graph(self, cuda_stream):
    ...
    def test_graph_launch(self, cuda_stream):
    ...
    def test_graph_destroy_cleanup(self, cuda_stream):

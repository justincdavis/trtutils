...
# def test_alt_letterbox_results():
#     trtutils.set_log_level("DEBUG")
#     import math
#     output_shape = (640, 640)
...
#     # now the cuda_result is a linearly resized image
#     # assign into the "letterboxed memory"
#     letterboxed = np.zeros((o_height, o_width, 3), dtype=np.uint8)
#     letterboxed += 114
#     letterboxed[pad_y:pad_y + new_height, pad_x:pad_x + new_width] = cuda_result

#     # cv2.imshow("CPU", resized_img)
#     # cv2.imshow("CUDA", letterboxed)
#     # cv2.waitKey(0)

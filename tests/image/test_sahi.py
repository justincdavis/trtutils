...
class TestSAHIIntegration:
    ...
    def test_sahi_end2end(self, yolov10_engine: Path, horse_image: np.ndarray) -> None:
    ...
    def test_sahi_with_slice_size(self, yolov10_engine: Path, horse_image: np.ndarray) -> None:

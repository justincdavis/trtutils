...
class TestYOLOv10:
    def test_single_image(self, make_yolov10_output, make_ratios_padding):
    ...
    def test_batch(self, make_yolov10_output, make_ratios_padding, batch_size):
    ...
    def test_batch_parity_with_single(self, make_yolov10_output, make_ratios_padding):
        batch_size = 3
        outputs = make_yolov10_output(batch_size=batch_size, num_dets=5)
        ratios, padding = make_ratios_padding(batch_size)
...
class TestEfficientNMS:
    def test_single_image(self, make_efficient_nms_output, make_ratios_padding):
    ...
    @pytest.mark.parametrize("batch_size", [2, 4])
    def test_batch(self, make_efficient_nms_output, make_ratios_padding, batch_size):
    ...
    def test_batch_parity_with_single(self, make_efficient_nms_output, make_ratios_padding):
        batch_size = 3
        outputs = make_efficient_nms_output(batch_size=batch_size, num_dets=5)
        ratios, padding = make_ratios_padding(batch_size)
...
class TestRFDETR:
    def test_single_image(self, make_rfdetr_output, make_ratios_padding):
    ...
    @pytest.mark.parametrize("batch_size", [2, 4])
    def test_batch(self, make_rfdetr_output, make_ratios_padding, batch_size):
    ...
    def test_batch_parity_with_single(self, make_rfdetr_output, make_ratios_padding):
        batch_size = 3
        outputs = make_rfdetr_output(batch_size=batch_size, num_dets=5)
        ratios, padding = make_ratios_padding(batch_size)
...
class TestDETR:
    def test_single_image(self, make_detr_output, make_ratios_padding):
    ...
    @pytest.mark.parametrize("batch_size", [2, 4])
    def test_batch(self, make_detr_output, make_ratios_padding, batch_size):
    ...
    def test_batch_parity_with_single(self, make_detr_output, make_ratios_padding):
        batch_size = 3
        outputs = make_detr_output(batch_size=batch_size, num_dets=5)
        ratios, padding = make_ratios_padding(batch_size)
...
class TestClassifications:
    def test_single_image(self, make_classification_output):
    ...
    @pytest.mark.parametrize("batch_size", [2, 4])
    def test_batch(self, make_classification_output, batch_size):
    ...
    def test_batch_parity_with_single(self, make_classification_output):
        batch_size = 3
        np.random.seed(42)
...
class TestGetClassifications:
    ...
    def test_top_k(self, make_classification_output, top_k):
...
class TestDifferentRatiosPerImage:
    def test_different_ratios(self, make_yolov10_output):
        batch_size = 2

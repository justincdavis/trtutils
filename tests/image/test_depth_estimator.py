...
class TestDepthEstimatorInference:
    ...
    def test_run_single_image(self, depth_engine: Path, horse_image: np.ndarray) -> None:
    ...
    def test_output_is_depth_map(self, depth_engine: Path, horse_image: np.ndarray) -> None:
    ...
    def test_depth_values_positive(self, depth_engine: Path, horse_image: np.ndarray) -> None:

...
def test_yolo_11_cpu_thread_run() -> None:
    """Test GPU engine runs with CPU preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="cpu", use_dla=False)


def test_yolo_11_cuda_thread_run() -> None:
    """Test GPU engine runs with CUDA preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="cuda", use_dla=False)


def test_yolo_11_dla_cpu_thread_run() -> None:
    """Test DLA engine runs with CPU preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="cpu", use_dla=True)


def test_yolo_11_dla_cuda_thread_run() -> None:
    """Test DLA engine runs with CUDA preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="cuda", use_dla=True)


def test_yolo_11_trt_thread_run() -> None:
    """Test GPU engine runs with TRT preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="trt", use_dla=False)


def test_yolo_11_dla_trt_thread_run() -> None:
    """Test DLA engine runs with TRT preproc in a thread."""
    yolo_run_in_thread(11, preprocessor="trt", use_dla=True)
...
def test_yolo_11_cpu_multi_thread_run() -> None:
    """Test multiple GPU engines runs with CPU preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="cpu", count=GPU_ENGINES, use_dla=False)


def test_yolo_11_cuda_multi_thread_run() -> None:
    """Test multiple GPU engines runs with CUDA preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="cuda", count=GPU_ENGINES, use_dla=False)


def test_yolo_11_dla_cpu_multi_thread_run() -> None:
    """Test multiple DLA engines runs with CPU preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="cpu", count=DLA_ENGINES, use_dla=True)


def test_yolo_11_dla_cuda_multi_thread_run() -> None:
    """Test multiple DLA engines runs with CUDA preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="cuda", count=DLA_ENGINES, use_dla=True)


def test_yolo_11_trt_multi_thread_run() -> None:
    """Test multiple GPU engines runs with TRT preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="trt", count=GPU_ENGINES, use_dla=False)


def test_yolo_11_dla_trt_multi_thread_run() -> None:
    """Test multiple DLA engines runs with TRT preproc in multiple threads."""
    yolo_run_multiple_threads(11, preprocessor="trt", count=DLA_ENGINES, use_dla=True)

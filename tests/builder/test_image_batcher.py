...
class TestImageBatcherInit:
    ...
    def test_init_valid_dir(self, test_image_dir) -> None:
    ...
    def test_max_images_truncates(self, test_image_dir) -> None:
...
class TestImageBatcherOutput:
    ...
    def test_batch_shape(self, test_image_dir, order, resize_method) -> None:
    ...
    def test_batch_dtype(self, test_image_dir) -> None:
    ...
    def test_batch_count(self, test_image_dir) -> None:
...
class TestImageBatcherIteration:
    ...
    def test_get_next_batch_returns_array(self, test_image_dir) -> None:
    ...
    def test_exhausted_returns_none(self, test_image_dir) -> None:
    ...
    def test_num_batches_property(self, test_image_dir) -> None:
    ...
    def test_batch_size_property(self, test_image_dir) -> None:
...
class TestImageBatcherThreading:
    ...
    def test_prefetch_queue(self, test_image_dir) -> None:
    ...
    def test_cleanup_on_close(self, test_image_dir) -> None:
    ...
    def test_atexit_registered(self, test_image_dir) -> None:
...
class TestImageBatcherValidation:
    ...
    def test_dtype_handling(self, test_image_dir, dtype) -> None:
    ...
    def test_c_contiguous_output(self, test_image_dir) -> None:
    ...
    def test_verbose_mode(self, test_image_dir) -> None:

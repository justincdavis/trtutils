...
#
# MIT License
"""GPU-dependent test fixtures, loaded by conftest.py when CUDA is available."""
...
from .conftest import BASE_DIR, DATA_DIR, ENGINES_DIR
...
def simple_onnx_path() -> Path:
    ...
    return BASE_DIR / "data" / "simple.onnx"
